...
# ══════════════════════════════════════════════════════════════════════════════
header "6. Info Folder Instalasi"
# ══════════════════════════════════════════════════════════════════════════════

info "Skrip tidak akan menghapus folder sumber kode (${INSTALL_DIR}) untuk keamanan."
info "Jika Anda ingin menghapusnya sepenuhnya, Anda bisa menghapusnya secara manual dengan:"
